...
class Optimizer(nn.Module, ABC):
    def __init__(self, model,adj, train_data, test_data, test_mask, train_mask, ap_fun, aupr_fun,rmse_fun, mae_fun, lr=0.0001, wd=1e-05, epochs=800, test_freq=1000, device="cpu", lam=0.01, eps=1e-8):
